...
$product_id = isset($_GET['product_id']) ? intval($_GET['product_id']) : 10;
...
<body>
  ...
  <div class="container1">
    ...
    <div class="product-details">
      ...
      <p><strong>Includes:</strong> Nail clippers, hairbrush, comb, nasal aspirator, thermometer, and scissors with
        rounded tips.</p>
      <p><strong>Design:</strong> Ergonomic design for easy handling and safety for newborns.</p>
      <p><strong>Durability:</strong> Made with high-quality, BPA-free materials for long-lasting use.</p>
      <p><strong>Portability:</strong> Comes with a travel-friendly storage case to keep everything organized.</p>
      <p class="price">RM
  ...
  <div class="container reviews">
    ...
    <p><strong>Ana P.:</strong> This kit has everything I need for my baby. Great value for money!</p>
    <p><strong>Daniel K.:</strong> The storage case is so convenient for traveling. Highly recommend!</p>
  </div>
