...
$product_id = isset($_GET['product_id']) ? intval($_GET['product_id']) : 3;
...
<body>
    ...
    <div class="container1">
      ...
      <div class="product-details">
        <h2><?php echo htmlspecialchars($product['name']); ?></h2>
          <p><strong>Material:</strong> 100% organic cotton, designed for sensitive baby skin.</p>
          <p><strong>Design:</strong> Coordinated twin outfits with matching patterns and colors.</p>
          <p><strong>Comfort:</strong> Breathable, lightweight fabric for all-day wear.</p>
          <p><strong>Fit:</strong> Adjustable waistbands for a snug and flexible fit.</p>
          <p><strong>Special Feature:</strong> Gender-neutral designs for any twin pairing.</p>
          <p class="price">RM<?php echo number_format($product['price'], 2); ?></p>
          <p class="stock-status in-stock">In Stock</p>
          <div class="size-selection">
            <label for="size">Select Size: </label>
            <select id="size">
                <option value="0-3 months">10-12 Months</option>
                <option value="3-6 months">1-2 years</option>
                <option value="6-12 months">3-4 years</option>
            </select>
        </div>
    ...
    <div class="container reviews">
        ...
        <p><strong>Emily T.:</strong> These mittens are so soft! Perfect for my newborn.</p>
        <p><strong>Linda K.:</strong> Great quality, and the elastic band keeps them from falling off.</p>
    </div>
