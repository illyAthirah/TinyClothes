...
$product_id = isset($_GET['product_id']) ? intval($_GET['product_id']) : 9;
...
<body>
  ...
  <div class="container1">
    ...
    <div class="product-details">
      ...
      <p><strong>Gentle Formula:</strong> Tear-free and mild on baby’s sensitive skin and eyes.</p>
      <p><strong>Fragrance:</strong> Fresh and soothing scent for a relaxing bath time.</p>
      <p><strong>Benefits:</strong> Helps maintain the natural moisture of baby’s hair and scalp.</p>
      <p><strong>Safety:</strong> Dermatologically tested and hypoallergenic.</p>
  ...
  <div class="container reviews">
    ...
    <p><strong>Maria T.:</strong> Perfect for my baby! No tears and leaves a lovely scent.</p>
    <p><strong>James L.:</strong> Affordable and gentle on my newborn’s skin. Highly recommend!</p>
  </div>
