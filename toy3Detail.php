...
$product_id = isset($_GET['product_id']) ? intval($_GET['product_id']) : 15;
...
<body>
  ...
  <div class="container1">
    ...
    <div class="product-details">
      ...
      <p><strong>Material:</strong> Made from high-quality, soft plush fabric, perfect for cuddling and playtime.</p>
      <p><strong>Design:</strong> Adorable penguin design with embroidered facial features and a cute little flipper.
      </p>
      <p><strong>Size:</strong> 12 inches tall (S), 18 inches tall (M), and 24 inches tall (L) for
        different cuddling experiences.</p>
      <p><strong>Safety:</strong> Hypoallergenic and non-toxic materials, fully safe for babies and toddlers.</p>
      <p class="price">RM
  ...
  <div class="container reviews">
    ...
    <p><strong>Mary T.:</strong> This penguin soft toy is so cute! My baby loves hugging it and it’s very soft.</p>
    <p><strong>Linda F.:</strong> The perfect toy for my little one. It’s durable, washable, and adorable!</p>
  </div>
