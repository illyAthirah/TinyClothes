...
$product_id = isset($_GET['product_id']) ? intval($_GET['product_id']) : 7;
...
<body>
      ...
      <div class="container1">
        ...
        <div class="product-details">
          <h2><?php echo htmlspecialchars($product['name']); ?></h2>
            <p><strong>Material:</strong> Made from high-quality, BPA-free plastic that is safe for babies and toddlers.</p>
            <p><strong>Design:</strong> Features a spill-proof lid, soft spout, and ergonomic handles designed for small hands to encourage self-feeding.</p>
            <p><strong>Capacity:</strong> Holds up to 200ml of liquid, perfect for introducing babies to drinking from a cup.</p>
            <p><strong>Ease of Use:</strong> The sippy cup’s soft spout and wide base help prevent spills and make drinking easier for babies transitioning from bottles.</p>
    ...
    <div class="container reviews">
        ...
        <p><strong>Jessica F.:</strong> Love this cup! My baby transitioned from bottle to this cup without any issues. The soft spout is gentle on her gums.</p>
        <p><strong>Rachel P.:</strong> This is a great sippy cup. It’s durable, easy to clean, and my baby enjoys drinking from it.</p>
    </div>
