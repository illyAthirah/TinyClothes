      ...
      <div class="row py-4 pb-0 pb-sm-4 align-items-center ">
        ...
        <div
          ...
          <div class="support-box text-end d-none d-xl-block">
            ...
            <h5 class="mb-0">+6012 3456 789</h5>
          </div>
          <div class="support-box text-end d-none d-xl-block">
            <span class="fs-6 secondary-font text-muted">Email</span>
            <h5 class="mb-0">TinyStore@gmail.com</h5>
          </div>
        </div>
      </div>
    </div>
            ...
            <ul class="navbar-nav menu-list list-unstyled d-flex gap-md-3 mb-0">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="pages">
                  ...
                  <li><a href="productPage.php" class="dropdown-item">Shop</a></li>
  ...
  <section id="clothing" class="my-5 overflow-hidden">
    <div class="container pb-5">
      <div class="section-header d-md-flex justify-content-between align-items-center mb-3">
        <h2 class="display-3 fw-normal">Baby Clothing</h2>
        <div>
          <a href="productPage.php" class="btn btn-outline-dark btn-lg text-uppercase fs-6 rounded-1">
            Shop Now
            <svg width="24" height="24" viewBox="0 0 24 24" class="mb-1">
      ...
      <div class="products-carousel swiper">
        <div class="swiper-wrapper">
          ...
          $sql = "SELECT * FROM products WHERE category = 'Clothes' ORDER BY created_at DESC";
          ...
          ?>
            <div class="swiper-slide">
              <div class="z-1 position-absolute rounded-3 m-3 px-3 border border-dark-subtle">
                <?php echo $product['is_featured'] ? 'Featured' : ''; ?>
              </div>
              <div class="card position-relative">
                <a href="baju<?php echo $product['product_id']; ?>detail.php">
                  <img src="images/<?php echo htmlspecialchars($product['image']); ?>" class="img-fluid rounded-4" alt="<?php echo htmlspecialchars($product['name']); ?>">
                </a>
                <div class="card-body p-0">
                  <a href="baju<?php echo $product['product_id']; ?>detail.php">
                    <h3 class="card-title pt-4 m-0"><?php echo htmlspecialchars($product['name']); ?></h3>
                  </a>
                  <div class="card-text">
  ...
  <section id="foodies" class="my-5">
    <div class="container my-5 py-5">
      ...
      <div class="section-header d-md-flex justify-content-between align-items-center">
        <h2 class="display-3 fw-normal">BABY FAV'S 🍼</h2>
        <div class="mb-4 mb-md-0">
          <p class="m-0">
            <button class="filter-button me-4 active" data-filter="*">ALL</button>
            <button class="filter-button me-4" data-filter=".bottle">BOTTLE</button>
            <button class="filter-button me-4" data-filter=".cutlury">DINNERWARE</button>
            <button class="filter-button me-4" data-filter=".toys">TOYS</button>
          </p>
        </div>
        <div>
          <a href="productPage.php" class="btn btn-outline-dark btn-lg text-uppercase fs-6 rounded-1">
      ...
      <div class="isotope-container row">
        ...
        // Fetch all products for Baby Fav's category
        $sql = "SELECT * FROM products WHERE product_id BETWEEN 21 AND 28"; // Restrict product_id range
        $result = $conn->query($sql);

        // Define a mapping for product_id to categories
        $category_map = [
          21 => 'bottle',
          22 => 'cutlury',
          23 => 'cutlury',
        ...
        // Define a mapping for product_id to detail pages
        $detail_map = [
          21 => 'fav1.php',
          22 => 'fav2.php',
          23 => 'fav3.php',
        ...
        while ($product = $result->fetch_assoc()) {
          $category_class = isset($category_map[$product['product_id']]) ? $category_map[$product['product_id']] : '';
          $detail_page = isset($detail_map[$product['product_id']]) ? $detail_map[$product['product_id']] : '#';
        ?>
          <div class="item <?php echo htmlspecialchars($category_class); ?> col-md-4 col-lg-3 my-4">
            <div class="card position-relative">
              <a href="<?php echo htmlspecialchars($detail_page); ?>">
                <img src="images/<?php echo htmlspecialchars($product['image']); ?>" class="img-fluid rounded-4" alt="<?php echo htmlspecialchars($product['name']); ?>">
              </a>
              <div class="card-body p-0">
                <a href="<?php echo htmlspecialchars($detail_page); ?>">
              ...
              <div class="swiper-slide">
                <div class="row ">
                  ...
                  <div class="col-md-10 mt-md-5 p-5 pt-0 pt-md-5">
                    <p class="testimonial-content fs-2">Discover a world of comfort, care, and cuteness with our
                      handpicked essentials
                      for your little bundle of joy</p>
                    <p class="text-black">- Aqilah Joharudin</p>
                  </div>
                </div>
              </div>
              <div class="swiper-slide">
                <div class="row ">
                  ...
                  <div class="col-md-10 mt-md-5 p-5 pt-0 pt-md-5">
                    <p class="testimonial-content fs-2">The littlest feet make the biggest imprints on your soul.
                      With every coo and giggle, a baby brings boundless joy.</p>
                    <p class="text-black">- Illy Athirah</p>
                  </div>
                </div>
              </div>
              <div class="swiper-slide">
                <div class="row ">
                  ...
                  <div class="col-md-10 mt-md-5 p-5 pt-0 pt-md-5">
                    <p class="testimonial-content fs-2">Every little one deserves a world full of softness and love.
                      Our products are thoughtfully crafted to make their journey magical.</p>
                    <p class="text-black">- Esah Carah</p>
                  </div>
                </div>
              </div>
    ...
    <div class="container py-5 mb-5">
      ...
      <div class="swiper bestselling-swiper">
        <div class="swiper-wrapper">
          ...
          $sql = "SELECT * FROM products WHERE category = 'Best'";
          $result = $conn->query($sql);
          ...
          while ($product = $result->fetch_assoc()) {
            ...
            $redirect_file = isset($redirect_map[$product['product_id']]) ? $redirect_map[$product['product_id']] : 'productDetail.php';
          ?>
            <div class="swiper-slide">
              <div class="card position-relative">
                <a href="<?php echo $redirect_file; ?>">
                  <img src="images/<?php echo htmlspecialchars($product['image']); ?>" class="img-fluid rounded-4" alt="<?php echo htmlspecialchars($product['name']); ?>">
                </a>
                <div class="card-body p-0">
                  <a href="<?php echo $redirect_file; ?>">
                  ...
                  <div class="card-text">
                    ...
                    <h3 class="secondary-font text-primary">RM<?php echo number_format($product['price'], 2); ?></h3>
                    <div class="d-flex flex-wrap mt-3">
                      <a href="add_to_cart.php?product_id=<?php echo $product['product_id']; ?>" class="btn-cart me-3 px-4 pt-3 pb-3">
                        <h5 class="text-uppercase m-0">Add to Cart</h5>
                      </a>
                      <a href="#" class="btn-wishlist px-4 pt-3">
                        <iconify-icon icon="fluent:heart-28-filled" class="fs-5"></iconify-icon>
    ...
    <div class="container py-5 my-5">
      ...
      <div class="row">
        <div class="col-md-4 my-4 my-md-0">
          ...
          <div class="card position-relative">
            <a href="single-post.html"><img src="images/blog-lg1.jpg" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="single-post.html">
                <h3 class="card-title pt-4 pb-3 m-0">10 Reasons to be helpful towards any kids</h3>
              </a>

              <div class="card-text">
                <p class="blog-paragraph fs-6">At the heart of our baby shop is the belief that nurturing children is
                  key to our future,
                  and creating a caring environment for them is our greatest achievement and hope for a better
                  tomorrow..</p>
        ...
        <div class="col-md-4 my-4 my-md-0">
          ...
          <div class="card position-relative">
            <a href="single-post.html"><img src="images/blog-lg2.jpg" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="single-post.html">
                <h3 class="card-title pt-4 pb-3 m-0">How to know your baby is hungry</h3>
              </a>

              <div class="card-text">
                <p class="blog-paragraph fs-6">
                  To know if your baby is hungry, look for signs like fussiness, sucking on hands, or crying.
                  Our baby shop has everything you need to care for your little one’s needs.</p>
                <a href="single-post.html" class="blog-read">read more</a>
              </div>
        ...
        <div class="col-md-4 my-4 my-md-0">
          ...
          <div class="card position-relative">
            <a href="single-post.html"><img src="images/blog-lg3.jpg" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="single-post.html">
                <h3 class="card-title pt-4 pb-3 m-0">Best home toys for your kids</h3>
              </a>

              <div class="card-text">
                <p class="blog-paragraph fs-6">At the core of our baby toys is the idea that playtime sparks creativity
                  and learning,
                  laying the foundation for your child’s greatest achievements and a bright future.</p>
                <a href="single-post.html" class="blog-read">read more</a>
              </div>
      ...
      <div class="row g-md-5 pt-4">
        <div class="col-md-3 my-3">
          <div class="card">
            ...
            <div class="card-text">
              <p class="blog-paragraph fs-6">Enjoy free delivery on all your baby essentials, straight to your door.</p>
            </div>
          </div>
        </div>
        <div class="col-md-3 my-3">
          <div class="card">
            ...
            <div class="card-text">
              <p class="blog-paragraph fs-6">Shop with confidence—your payment is completely secure.</p>
            </div>
          </div>
        </div>
        <div class="col-md-3 my-3">
          <div class="card">
            ...
            <div class="card-text">
              <p class="blog-paragraph fs-6">Check out our daily offers for amazing discounts on baby products!</p>
            </div>
          </div>
        </div>
        <div class="col-md-3 my-3">
          <div class="card">
            ...
            <div class="card-text">
              <p class="blog-paragraph fs-6">We ensure top-quality products for your little one, every time.</p>
            </div>
          </div>
        </div>
