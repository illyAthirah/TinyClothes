...
$product_id = isset($_GET['product_id']) ? intval($_GET['product_id']) : 16;
...
<body>
  ...
  <div class="container1">
    ...
    <div class="product-details">
      ...
      <p><strong>Material:</strong> Made from non-toxic plastic, safe for babies to explore and play with. Colorful
        piano keys that light up and make fun sounds.</p>
      <p><strong>Features:</strong> This musical toy helps babies develop their hearing, motor skills, and hand-eye
        coordination. It includes different musical modes and sound effects.</p>
      <p><strong>Size:</strong> Small enough to be portable, with a child-friendly design and smooth edges for safe
        handling.</p>
      <p><strong>Age Range:</strong> Suitable for babies aged 6 months and above.</p>
      <p class="price">RM
  ...
  <div class="container reviews">
    ...
    <p><strong>Jane D.:</strong> My baby loves the piano sounds, and it’s perfect for her tiny hands! Highly recommend.
    </p>
    <p><strong>Tom F.:</strong> Excellent toy! Great quality and educational, keeps my baby entertained for hours.</p>
  </div>
