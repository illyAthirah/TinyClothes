...
$product_id = isset($_GET['product_id']) ? intval($_GET['product_id']) : 18;
...
<body>
  ...
  <div class="container1">
    ...
    <div class="product-details">
      ...
      <p><strong>Material:</strong> High-quality, breathable fabric for comfort, with sturdy plastic shell and padded
        support.</p>
      <p><strong>Safety Features:</strong> 5-point harness system, side-impact protection, and adjustable headrest for
        added safety and comfort.</p>
      <p><strong>Installation:</strong> Easy installation with either a seat belt or LATCH system (depending on car
        compatibility).</p>
      <p><strong>Age Range:</strong> Suitable for babies 0-12 months for rear-facing, and toddlers 1-4 years for
        front-facing (depending on the seat's configuration).</p>
  ...
  <div class="container reviews">
    ...
    <p><strong>Jane D.:</strong> This car seat is very secure and easy to install. I feel confident knowing my baby is
      safe.</p>
    <p><strong>Michael L.:</strong> Love this car seat! The padding is so comfortable and the adjustable features make
      it perfect for growing babies.</p>
  </div>
