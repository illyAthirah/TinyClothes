...
$product_id = isset($_GET['product_id']) ? intval($_GET['product_id']) : 4;
...
<body>
  ...
  <div class="container1">
    ...
    <div class="product-details">
      ...
      <p><strong>Material:</strong> Lightweight and ultra-soft cotton blend, perfect for warm weather.</p>
      <p><strong>Design:</strong> Adorable summer-themed patterns with a breezy fit for maximum comfort.</p>
      <p><strong>Comfort:</strong> Breathable fabric to keep the baby cool and comfortable all day.</p>
      <p><strong>Protection:</strong> Helps prevent overheating and protects delicate skin from the sun.</p>
  ...
  <div class="container reviews">
    ...
    <p><strong>Anna P.:</strong> Adorable and fits my baby perfectly. The material is so soft!</p>
    <p><strong>Sarah J.:</strong> Great value for money, and my baby loves wearing it!</p>
  </div>
