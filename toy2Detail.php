...
$product_id = isset($_GET['product_id']) ? intval($_GET['product_id']) : 14;
...
<body>
                ...
                <ul class="navbar-nav menu-list list-unstyled d-flex gap-md-3 mb-0">
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="pages">
                      ...
                      <li><a href="productPage.html" class="dropdown-item">Shop</a></li>
      ...
      <div class="container1">
        ...
        <div class="product-details">
          <h2>
            ...
            <p><strong>Material:</strong> Made from high-quality, BPA-free wood and non-toxic paints for safety and durability.</p>
            <p><strong>Developmental Benefits:</strong> Enhances fine motor skills, hand-eye coordination, and cognitive development in young children.</p>
            <p><strong>Design:</strong> Multi-colored blocks with numbers, shapes, and animals for engaging learning through play.</p>
            <p><strong>Age Range:</strong> Suitable for children aged 12 months and up.</p>
            <p><strong>Features:</strong> The blocks can be stacked, arranged, and used to form patterns, encouraging creativity and problem-solving skills.</p>
            <p class="price">RM
    ...
    <div class="container reviews">
        ...
        <p><strong>Alice M.:</strong> This toy is amazing! My baby loves to play with the blocks, and it has really helped with her motor skills!</p>
        <p><strong>John R.:</strong> I love how sturdy the blocks are and how easy it is for my toddler to handle them. Great learning tool!</p>
    </div>
