...
$product_id = isset($_GET['product_id']) ? intval($_GET['product_id']) : 26;
...
<body>
  ...
  <div class="container1">
    ...
    <div class="product-details">
      ...
      <p><strong>Material:</strong> Made from safe, non-toxic, and eco-friendly wood or high-quality plastic, perfect for babies and toddlers.</p>
      <p><strong>Design:</strong> Features colorful and easy-to-handle puzzle pieces with animal shapes, letters, or numbers to stimulate cognitive skills.</p>
      <p><strong>Learning Benefits:</strong> Enhances problem-solving skills, hand-eye coordination, and fine motor development through interactive play.</p>
      <p><strong>Safety:</strong> Smooth edges and durable design ensure safe play for young children.</p>
      <div class="color-selection">
        <label for="color">Select Design: </label>
        <select id="color">
  ...
  <div class="container reviews">
    ...
    <p><strong>Amy C.:</strong> This puzzle box is fantastic! It’s so much fun, and my baby loves to play with the pieces.</p>
    <p><strong>Robert S.:</strong> A great learning tool! My toddler is getting better at matching and recognizing letters. Highly recommend!</p>
  </div>
