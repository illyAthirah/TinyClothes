...
$product_id = isset($_GET['product_id']) ? intval($_GET['product_id']) : 20;
...
<head>
  ...
  <title>
    <?php echo htmlspecialchars($product['name']); ?> - Tiny Clothes
  </title>
...
<body>
      ...
      <div class="order-md-last">
        ...
        <ul class="list-group mb-3">
          <li class="list-group-item d-flex justify-content-between lh-sm">
            ...
            <span class="text-body-secondary">RM12</span>
          </li>
          <li class="list-group-item d-flex justify-content-between lh-sm">
            <div>
            ...
            <span class="text-body-secondary">RM8</span>
          </li>
          <li class="list-group-item d-flex justify-content-between lh-sm">
            <div>
            ...
            <span class="text-body-secondary">RM5</span>
          </li>
          <li class="list-group-item d-flex justify-content-between">
            <span class="fw-bold">Total (RM)</span>
            <strong>RM20</strong>
          </li>
        </ul>
  ...
  <div class="container1">
    <div class="product-image">
      <img src="images/<?php echo htmlspecialchars($product['image'] ?? 'default.png'); ?>"
    ...
    <div class="product-details">
      ...
      <p><strong>Material:</strong> Made from ultra-soft cotton blend, providing comfort and support for both parents
        and babies.</p>
      <p><strong>Design:</strong> Simple, flexible design for easy wrapping and secure carrying. Suitable for newborns
        and older infants.</p>
      <p><strong>Benefits:</strong> Offers hands-free convenience and promotes bonding between parent and child. Ideal
        for travel or around-the-house use.</p>
      <p><strong>Comfort:</strong> Stretchable fabric ensures an ergonomic fit, allowing both parent and baby to remain
        comfortable for longer periods.</p>
      <div class="size-selection">
        <label for="size">Select Size: </label>
        <select id="size">
          <?php while ($variant = $variants->fetch_assoc()) { ?>
          <option value="<?php echo htmlspecialchars($variant['variant_name']); ?>"
            data-price="<?php echo htmlspecialchars($variant['price']); ?>">
            <?php echo htmlspecialchars($variant['variant_name'], 2); ?>
          </option>
          <?php } ?>
        </select>
      </div>
  ...
  <div class="container reviews">
    ...
    <p><strong>Linda G.:</strong> I absolutely love this wrap! It’s so comfortable and easy to use. Perfect for carrying
      my baby around all day.</p>
    <p><strong>Mark T.:</strong> The material is so soft and breathable. My baby loves being carried in it!</p>
  </div>
