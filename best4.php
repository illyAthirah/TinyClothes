...
<body>
      ...
      <div class="container1">
        ...
        <div class="product-details">
          <h2><?php echo htmlspecialchars($product['name']); ?></h2>
            <p><strong>Material:</strong> Made from durable, non-toxic plastic that is safe for children and perfect for beach play.</p>
            <p><strong>Set Includes:</strong> A variety of toys such as a bucket, shovel, rake, mold shapes (like sandcastles, animals), and a water scooper to provide endless fun at the beach.</p>
            <p><strong>Design:</strong> Lightweight, easy-to-carry pieces that are perfect for small hands to grip and play with.</p>
            <p><strong>Features:</strong> Bright and colorful toys to engage your child and stimulate imagination while promoting motor skills and hand-eye coordination.</p>
    ...
    <div class="container reviews">
        ...
        <p><strong>Lisa T.:</strong> This beach toy set was a huge hit with my little one! She had so much fun building sandcastles and playing with the molds.</p>
        <p><strong>Tom H.:</strong> Great quality set for beach days. The pieces are easy to carry, and my toddler loves playing with them in the sand and water.</p>
    </div>
