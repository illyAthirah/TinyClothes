...
$product_id = isset($_GET['product_id']) ? intval($_GET['product_id']) : 24;
...
<body>
  ...
  <div class="container1">
    ...
    <div class="product-details">
      ...
      <p><strong>Material:</strong> Made from BPA-free, food-grade silicone and plastic for safety and durability.</p>
      <p><strong>Design:</strong> Spill-proof lid with a soft spout to help transition from bottle to cup, and easy-grip
        handles for little hands.</p>
      <p><strong>Capacity:</strong> Holds up to 200ml, ideal for small portions.</p>
      <p><strong>Durability:</strong> Dishwasher-safe and shatterproof, designed to withstand drops and daily use.</p>
  ...
  <div class="container reviews">
    ...
    <p><strong>Sophie M.:</strong> Perfect for transitioning! My baby loves using this cup, and it's completely
      spill-proof.</p>
    <p><strong>Henry T.:</strong> The handles make it super easy for my toddler to hold. Great quality and safe
      materials!</p>
  </div>
