...
$product_id = isset($_GET['product_id']) ? intval($_GET['product_id']) : 11;
...
<body>
  ...
  <div class="container1">
    ...
    <div class="product-details">
      ...
      <p><strong>Material:</strong> Made from BPA-free, durable, and non-toxic plastic for safety and comfort.</p>
      <p><strong>Design:</strong> Ergonomic shape with anti-slip padding to keep your baby secure during bath time.</p>
      <p><strong>Size:</strong> Perfect for newborns and infants up to 12 months. Dimensions: 80cm x 50cm x 30cm.</p>
      <p><strong>Features:</strong> Includes a water-level indicator, drainage plug, and compact design for easy storage.</p>
      <p class="price">RM
  ...
  <div class="container reviews">
    ...
    <p><strong>Sarah M.:</strong> This bathtub is so easy to use and keeps my baby safe during bath time. Highly
      recommend!</p>
    <p><strong>James R.:</strong> The drainage plug is a great feature. No more heavy lifting to empty the tub!</p>
  </div>
