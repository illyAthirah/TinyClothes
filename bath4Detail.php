...
$product_id = isset($_GET['product_id']) ? intval($_GET['product_id']) : 12;
...
<body>
      ...
      <div class="product-details">
        <h2>
          <?php echo htmlspecialchars($product['name']); ?>
            ...
            <p><strong>Ingredients:</strong> Made with natural, organic ingredients like aloe vera, chamomile, and shea butter for gentle hydration.</p>
            <p><strong>Hypoallergenic:</strong> Dermatologist-tested and free from parabens, sulfates, and artificial fragrances, making it safe for sensitive skin.</p>
            <p><strong>Usage:</strong> Suitable for daily use, perfect for baby’s delicate skin after bath time to lock in moisture and protect against dryness.</p>
            <p class="price">RM
    ...
    <div class="container reviews">
        ...
        <p><strong>Emma T.:</strong> This lotion is so soft and soothing for my baby. It smells great and keeps her skin moisturized all day!</p>
        <p><strong>Lucas J.:</strong> I love how natural this lotion feels. My baby’s skin is sensitive, and this works perfectly!</p>
    </div>
