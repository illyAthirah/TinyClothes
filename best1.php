...
$product_id = isset($_GET['product_id']) ? intval($_GET['product_id']) : 5;
...
<body>
  ...
  <div class="container1">
    ...
    <div class="product-details">
      ...
      <p><strong>Material:</strong> Made from soft, breathable cotton fabric for ultimate comfort during the baby shower event.</p>
      <p><strong>Design:</strong> Adorable and fun designs perfect for a baby shower celebration, featuring baby-themed graphics such as cute animals, onesies, and bottles.</p>
      <p><strong>Comfort:</strong> Soft and stretchy to fit toddlers comfortably while allowing for easy movement during festivities.</p>
      <p><strong>Durability:</strong> High-quality stitching ensures long-lasting wear for multiple celebrations.</p>
  ...
  <div class="container reviews">
    ...
    <p><strong>Jane D.:</strong> This outfit is perfect for a baby shower event! It’s super cute and comfortable for my
      little one.</p>
    <p><strong>Michael L.:</strong> My toddler loved wearing this. It was a hit at the baby shower, and the fabric is
      soft and gentle on his skin.</p>
  </div>
